...
<form class="flex items-center gap-2 px-3 py-1.5 bg-surface-raised border-b border-border" onsubmit={e => { e.preventDefault(); }}>
	...
	<input
		...
		{disabled}
		class="flex-1 px-2 py-1 text-sm font-mono bg-input border border-border rounded-sm text-text-primary placeholder:text-text-muted disabled:opacity-50"
